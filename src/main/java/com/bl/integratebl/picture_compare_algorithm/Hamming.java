...
public class Hamming {
    // 全流程
    public double getSimilarity(BufferedImage image1, BufferedImage image2){
        int[] pixels1 = getImgFinger(image1);
        int[] pixels2 = getImgFinger(image2);
...
// 通过汉明距离计算相似度，取值范围 [0.0, 1.0]
    ...
    private int[] getImgFinger(BufferedImage imageFile){
