...
$(function () {
	...
	/* 主页菜单点击动作 */
	.click(function () {
        var target="myPhotos",type="top",$area=$(".area_"+type),flag = $area.data('flag') ? $area.data('flag') : '';
		if(target && $area.find('.box_'+ target).length == 0) {
			$area.append('<div class="scroll-pane box box_'+ target +'"></div>');
			var new_content="<div class=\"content\">\n" +
                "\t<div class=\"photos_area\">\n" +
                "\t</div>\n" +
                "\t<div class=\"wall_area\">\n" +
                "\t\t<div class=\"album_box rel\">\n" +
                "\t\t\t<div class=\"toolbar rel\">\n" +
                "\t\t\t\t<button type=\"button\" class=\"close\" ><span aria-hidden=\"true\">&times;</span><span class=\"sr-only\">Close</span></button>\n" +
                "\t\t\t</div>\n" +
                "\t\t\t<div class=\"album album_normal\">\n" +
                "\t\t\t\t<div class=\"left_area l scroll-pane\">\n" +
                "\t\t\t\t\t<ul class=\"photos_list \">\n" +
                "\t\t\t\t\t</ul>\n" +
                "\t\t\t\t</div>\n" +
                "\t\t\t\t<div class=\"content_area l\">\n" +
                "\t\t\t\t\t<div class=\"album_list my_album\"></div>\n" +
                "\t\t\t\t\t<div class=\"album_toolbar tc\">\n" +
                "\t\t\t\t\t\t<!-- <a class=\"needtooltip glyphicon glyphicon-share-alt ro180\" href=\"#\" data-toggle=\"tooltip\" data-placement=\"bottom\"   title=\"左旋转\"></a>  \n" +
                "\t\t\t\t\t\t<a class=\"needtooltip glyphicon glyphicon-share-alt \" href=\"#\" data-toggle=\"tooltip\" data-placement=\"bottom\"   title=\"右旋转\"></a>   -->\n" +
                "\t\t\t\t\t\t<a class=\"needtooltip glyphicon glyphicon-zoom-in \" href=\"#\" data-toggle=\"tooltip\" data-placement=\"bottom\"   title=\"放大\"></a>  \n" +
                "\t\t\t\t\t\t<a class=\"needtooltip glyphicon glyphicon-zoom-out\" href=\"#\" data-toggle=\"tooltip\" data-placement=\"bottom\"   title=\"缩小\"></a>  \n" +
                "\t\t\t\t\t</div>\n" +
                "\t\t\t\t</div>\n" +
                "\t\t\t</div>\n" +
                "\t\t\t<div class=\"album album_wall ovh\">\n" +
                "\t\t\t\t<ul class=\"album_wall_area ovh\">\n" +
                "\t\t\t\t\t<li><div class=\"fix l\"></div></li>\n" +
                "\t\t\t\t\t<li><div class=\"fix l\"></div></li>\n" +
                "\t\t\t\t\t<li><div class=\"fix l\"></div></li>\n" +
                "\t\t\t\t</ul>\n" +
                "\t\t\t</div>\n" +
                "\t\t\t<div class=\"album album_mark ovh\">\n" +
                "\t\t\t\t<div id=\"wrapper\">\n" +
                "\t\t\t\t\t<div id=\"carousel\">\n" +
                "\t\t\t\t\t\t\n" +
                "\t\t\t\t\t</div>\n" +
                ...
                "\t</div>\n" +
                "</div>";
			$area.find('.box_'+ target).append(new_content);
			// var path="./templates/"+target;
			// $area.find('.box_'+ target).load(path+".html",function () {
...
// $(function () {
	...
	function myPhotos() {
        ...
        var datas = data_myPhotos;
		var $myPhotos = $('.box_myPhotos'),$albumBox = $('.album_box'),$photosArea = $('.photos_area'),$albumToolbar = $('.album_toolbar');
		...
		function buildPhotosNormal (index) {
			...
			for(var i = 0; i < length; i ++) {
				...
				html.push('<li class="rel"><img src="'+ text +'" ><aside class="abs tc">'+ title +'</aside></li>');
				albumList.push({imgUrl : text,description : description});
			}
		...
		function buildPhotosList (_photos) {
			...
			for(var i = 0; i < length; i ++ ) {
				...
				html.push('<div class="photo_area" data-index="'+ i +'"><div class="photo_box3" style="display: none" data-type="'+ type[1] +'"><div class="photo_content tc">'+ photoType[type[1]] +'</div></div>');
				html.push('<div class="photo_box2" style="display: none" data-type="'+ type[0] +'"><div class="photo_content tc">'+ photoType[type[0]] +'</div></div><div class="photo_box" data-type="normal"><div class="photo_content tc">');
